...
var genNum = function (alphabet, cb) {
...
var genId = function(options, cb) {
    ...
    this.genNum(alphabet, function(err,num){
...
module.exports = exports = {genNum: genNum, genId: genId, defaultAlphabets: defaultAlphabets};
